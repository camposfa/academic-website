...
- Use the [`breaks_log()`](https://scales.r-lib.org/reference/label_log.html) function to control the spacing of tick marks along your transformed x-axis. Eight breaks looks pretty good to me.
