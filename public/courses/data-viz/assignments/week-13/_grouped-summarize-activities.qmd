---
title: "Grouped and summary operations"
format: 
  html:
...
Extract the rows where name is "Khaleesi". Then use summarize() and a summary functions to find:
...
Use group_by() and summarize() to calculate the number of male and female babies born in each year. 
...
Using baby names, add a rank column to each name for each year and sex. What were the top 1 and 2 ranked boys names for years 2012 to 2017 (which is the end of the data set)?
